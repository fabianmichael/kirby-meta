...
return [
    ...
    'fabianmichael.meta.global_robots_index.label' => 'Indexierunge',
    ...
    'fabianmichael.meta.global_default_value.label' => 'Website-Standard ({ state })',
    'fabianmichael.meta.config_default_value.label' => 'Konf.-Standard ({ state })',
